...
#define CASE_LABEL(x) case x: return #x;
	...
	CASE_LABEL(MSG_META_DEMO_TOGGLE_SHADOWS)
	...
	CASE_LABEL(MSG_META_DEMO_CYCLE_DEBUG_VIS)
	CASE_LABEL(MSG_META_DEMO_CYCLE_DEBUG_VIS_BACK)
	CASE_LABEL(MSG_META_DEMO_DEBUG_VIS_OFF)
#endif
