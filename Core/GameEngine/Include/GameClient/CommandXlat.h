...
enum FilterTypes CPP_11(: Int)
{
	...
	FT_VIEW_BLOOM,					///<screen-space bloom post-process (bright-pass + blur + composite).
	FT_MAX
};
...
enum FilterModes CPP_11(: Int)
{
	...
	FM_VIEW_BLOOM,		// Mode for FT_VIEW_BLOOM (any non-null mode keeps the filter active).
