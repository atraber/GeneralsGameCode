...
void W3DBibBuffer::loadBibsInVertexAndIndexBuffers()
{
	...
	UnsignedShort *ib;
	// Lock the buffers.
	DX8IndexBufferClass::WriteLockClass lockIdxBuffer(m_indexBib, GFX_MAP_WRITE_DISCARD);
	DX8VertexBufferClass::WriteLockClass lockVtxBuffer(m_vertexBib, GFX_MAP_WRITE_DISCARD);
