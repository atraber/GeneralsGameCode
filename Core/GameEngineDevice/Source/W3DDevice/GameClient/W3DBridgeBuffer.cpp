...
void W3DBridgeBuffer::loadBridgesInVertexAndIndexBuffers(RefRenderObjListIterator *pLightsIterator)
{
	...
	UnsignedShort *ib;
	// Lock the buffers.
	DX8IndexBufferClass::WriteLockClass lockIdxBuffer(m_indexBridge, GFX_MAP_WRITE_DISCARD);
	DX8VertexBufferClass::WriteLockClass lockVtxBuffer(m_vertexBridge, GFX_MAP_WRITE_DISCARD);
