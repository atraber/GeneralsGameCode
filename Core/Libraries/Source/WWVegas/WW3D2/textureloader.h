...
class TextureLoadTaskClass : public TextureLoadTaskListNodeClass
{
	public:
		...
		GfxTexture	*	Peek_D3D_Texture			()				{ return (GfxTexture*)D3DTexture;		}
...
private:
	...
	GfxTexture*	Peek_D3D_Cube_Texture()				{ return (GfxTexture*)D3DTexture;		}
...
private:
	...
	GfxTexture*	Peek_D3D_Volume_Texture()				{ return (GfxTexture*)D3DTexture;		}
